...
from settings import USE_DUMMY, PSO_REPORTS_DIR
...
from src.features.optimisation.results_helpers import post_iteration_processing, create_run_results_df
from src.features.file_helpers import create_dir
from src.features.optimisation.processing import PlayerDataProcessor, fun_min_reduced, OptInfo
...
if __name__ == '__main__':
    ...
    if __name__ == '__main__':
        for i, player_name in enumerate(players_list):
            ...
            save_path = os.path.join(PSO_REPORTS_DIR, player_save_name)
            ...
            for j in range(NUM_RUNS):
                ...
                # init vector but not actually used
